 ...
 */
void proximity(const std::vector<std::vector<float>> &points, int index, std::vector<int> &cluster, float distanceTol, KdTree *tree, std::unordered_set<int> &processedPoints)
{
